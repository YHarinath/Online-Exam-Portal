...
const MOCK_NOTIFICATIONS = [
  { id: 1, title: "New exam available", body: "Introduction to Python is now live.", time: "2m ago", unread: true },
  { id: 2, title: "Result published", body: "Your score for Data Structures: 84%", time: "1h ago", unread: true },
  { id: 3, title: "Reminder", body: "Algorithms exam starts in 30 minutes.", time: "3h ago", unread: false },
];
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-slate-900">
      ...
      <main className="flex-1 flex flex-col relative overflow-hidden">
                ...
                <div className="absolute right-0 top-12 w-60 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-white/10 overflow-hidden z-50">
                  ...
                  <div className="px-4 py-4 border-b border-gray-100 dark:border-white/10 bg-gradient-to-br from-indigo-50 to-cyan-50 dark:from-indigo-900/20 dark:to-cyan-900/10">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="overflow-hidden">
                        <p className="text-sm font-bold text-gray-800 dark:text-white truncate">{user?.name ?? "Student"}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{user?.email ?? ""}</p>
        ...
        <div className="flex-1 overflow-auto p-8 relative">
          <div className="absolute top-[-50px] right-[-100px] w-80 h-80 bg-cyan-400/20 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-[-100px] left-[-50px] w-80 h-80 bg-indigo-600/10 rounded-full blur-[100px] pointer-events-none" />
